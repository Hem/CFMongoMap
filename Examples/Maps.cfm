<cfscript>
	...
	map = new Map('examples.demo.poco.Person')
				.mapProperty('id')
					.toField('_id')
					.asPropertyType('ObjectId')
					// NOTE: Set this as 'ObjectID' if you wish to work 
					// with the DBObjectId object instead of "String"
					.asDataType('String')
				...
				.mapProperty('addresses')
					.asPropertyType('Array')
					// 	NOTE: DataType 'Mapped' when you are working with 
					//		  NON-SIMPLE Object Types.. Struct, CFC, Java Objects
					.asDataType('Mapped')
					
					.usingMap( // NOTE: Embeding a map for array of addresses
						new Map('examples.demo.poco.Address')
